# Generated by Django 2.1.7 on 2019-05-04 17:42
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('event_state', models.CharField(choices=[('P', 'Pending'), ('A', 'Approved'), ('R', 'Refused')], default='P', max_length=1, verbose_name='State of the event')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('manager', compositefk.fields.CompositeOneToOneField(null_if_equal=[], on_delete=django.db.models.deletion.CASCADE, to='event.Manager', to_fields={'assos_id': compositefk.fields.LocalFieldValue('assos_id'), 'profile_id': compositefk.fields.LocalFieldValue('profile_id')})),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('birth_date', models.DateField(validators=[event.models.validate_birth], verbose_name='Birth Date')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('event_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='event.Event')),
                ('profile_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='event.Profile')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='member',
            name='profile_id',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='memberships', to='event.Profile'),
        ),
        migrations.AddField(
            model_name='manager',
            name='member',
            field=compositefk.fields.CompositeOneToOneField(null_if_equal=[], on_delete=django.db.models.deletion.CASCADE, to='event.Member', to_fields={'assos_id': compositefk.fields.LocalFieldValue('assos_id'), 'profile_id': compositefk.fields.LocalFieldValue('profile_id')}),
        ),
        migrations.AddField(
            model_name='manager',
            name='profile_id',
